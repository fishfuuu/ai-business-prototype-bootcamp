...
今天直接沿 Task 1—4 看见五个概念：Task 1 圈定业务问题边界，Task 2 通过 grill-me 追问冻结业务契约与数据契约，Task 3 把口头预期写成 Given-When-Then 验收场景，Task 4 安装并使用第一课已见过的 $grill-me 技能。
...
**Grill-Me 结构化追问** 是操作方法：通过三维消歧（范围/数据/异常）追问出契约细节。**业务功能卡（BUSINESS_FEATURE_CARD.md）** 是承载契约的交付产物，不是独立概念。
