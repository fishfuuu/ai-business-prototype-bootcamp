# 第四课学员指南 V4——把契约切成一个可实施的薄片

> **本课核心思想只有一句话：**
> **不要让 Agent 一口气完成整个功能，而是先形成计划，每次只完成一个可验证的小切片。**

> **状态：V4_CONTENT_FROZEN（2026-08-12 用户确认）**。本课保留原第四课"切薄片实施"主线。第三课负责把事情说对，第四课负责把一小件事情做对。本课的 Agent 是实施原型的开发 Agent；Plan & Execute 是开发协作方式，不等于学员业务已经适合 Agent 化。
