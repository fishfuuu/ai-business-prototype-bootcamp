# 第五课学员指南 V4——第一次把 AI/Agent 融入业务

> **本课核心思想只有一句话：**
> **不是给每个环节都塞 AI，而是逐环节判断需要什么程度的智能，并选择最简单足够的方式。**

> **状态：V4_CONTENT_FROZEN（2026-08-12 用户确认）**。本课保留原第五课"理清 Agent 控制流"的教学价值，但将视角从工程控制流转为业务 AI 介入判断。原版 ReAct 概念和探险家比喻保留并改写为业务视角；鞍具缰绳比喻降级为 Guardrail 扩展认识。
