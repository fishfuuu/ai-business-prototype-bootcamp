...
| 设计规范 | 根目录 `DESIGN.md` |
| 学员可读课程文档 | 当前课程状态所需文档，例如第一课起点包中的 `docs/COMPONENT_CATALOG.md`、`docs/LESSON_01_GUIDE.md`、`docs/LESSON_01_AI_BASICS.md` 以及视觉素材图片 `docs/assets/lesson-01/lesson-flow.png`、`docs/assets/lesson-01/page-layout.png`、`docs/assets/lesson-01/component-map.png`、`docs/assets/lesson-01/first-cohort-example.png` |
