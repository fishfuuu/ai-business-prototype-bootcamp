 ...
 - L1-L10 single-lesson teacher plans, guides, derived assets — future independent changes
 - Script governance (doctor/test:ui/verify) — future independent change
 - GLOSSARY.md — future independent change
 - student-package/templates/CLAUDE.md — protected, not in Phase 1
 - Any classroom runtime, trial teaching, real teaching evidence — deferred programme evidence
 ...
 - Mirror missing for change-state.json — non-blocking governance follow-up
 ...
 Decision: 批准 Gate B — Phase 1 production implementation ACCEPTED
